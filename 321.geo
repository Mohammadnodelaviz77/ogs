...
//Physical Curve("right", 30) = {16, 12, 11, 2};
//+
Physical Surface("888", 30) = {3};
//+
Physical Surface("666", 31) = {5};
//+
Physical Surface("444", 32) = {4};
//+
Physical Surface("222", 33) = {2};
//+
Physical Surface("555", 34) = {6};
//+
Physical Surface("555", 34) += {7};
